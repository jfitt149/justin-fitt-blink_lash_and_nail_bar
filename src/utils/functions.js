 ...
 */
export const formatTime = (durationInMs) => {
 ...
 */
export const getStaffInitials = (displayName) => {
 ...
 */
export const convertDateToText = (dateStr, businessTimeZone) => {
  const date = new Date(dateStr);
  const d = new Date(
    date.toLocaleString("en-US", { timeZone: businessTimeZone })
  );
  const weekdays = [
    "Sunday",
    "Monday",
 ...
 * @param {String} businessTimeZone the IANA timezone of the business
 */
export const convertTimeToText = (dateStr, businessTimeZone) => {
  const date = new Date(dateStr);
  const d = new Date(
    date.toLocaleString("en-US", { timeZone: businessTimeZone })
  );
 ...
 */
export const formatDateToParts = (current, businessTimeZone, minutes) => {
